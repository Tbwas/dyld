...
#if __has_include(<include/mach-o/dyld_priv.h>)
#include <include/mach-o/dyld_images.h>
#include <include/mach-o/dyld_priv.h>
#else
...
public:	static uint32_t				fgTotalSegmentsMapped;
public: static uint64_t				fgTotalBytesMapped;
